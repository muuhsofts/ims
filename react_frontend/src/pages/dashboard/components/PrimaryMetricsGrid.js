...
import { PeopleAlt, Storefront, LocalShipping, Receipt, ShoppingCart, Category, Inventory } from '@mui/icons-material';
...
const PrimaryMetricsGrid = ({ cards }) => {
    const metrics = [
        ...
        { title: 'Purchases', value: cards.total_purchases || 0, icon: Receipt, color: '#f8961e' },
